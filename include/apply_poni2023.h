...
public:
    ...
    void init_map()
    {
        ...
        auto [q1, r1] = std::div((int)pixel_index[valid_count-1], 578);
        cout << "q r "<< q1<<" "<<r1<<" "<<center_qb[pixel_index[valid_count-1]*2]<<endl;
    }
    ...
    void average_sort(size_t *pix, int len,  int *dat)
    {
        reset();
        cout << len<<endl;
        int icount = 0;
  ...
  //      cout <<"sorted"<<endl;
    ...
    void robust_average(size_t *pix, int len, int *dat, double vmin, double vmax)
    {
        reset();
  ...
  //          cout << i << " "<<vmin<<" "<<vmax<<" "<< value<<endl;
    ...
    void integrate(int *dat, average_data *avg)
    {
